...
> Note: Code example taken from the [original ASP.NET Core repository](https://github.com/aspnet/Identity/blob/rel/2.0.0/src/Microsoft.Extensions.Identity.Core/PasswordHasher.cs#L70).\_
