---
title: "UTXO 与账户余额模型"
date: 2022-07-23T16:43:48+08:00
draft: false
categories: [dev]
tags: [dev, btcoin]
---
> 原文地址 [draveness.me](https://draveness.me/utxo-account-models/)

目前的绝大多数区块链项目不是使用 *UTXO 模型*作为底层的数据结构，就是使用*账户余额模型*存储交易相关的信息。

![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/021407ca.png)

在这篇文章中，我们会分别展示两种不同区块链模型的实现方式以及优缺点，我们会以 Bitcoin 和 Ethereum 为例分别介绍 UTXO 模型和账户余额模型。

## 区块与区块链

在具体介绍 UTXO 模型和账户余额模型之前，我们不得不首先介绍它们两者、甚至所有区块链应用中最重要的概念和数据结构，也就是 _区块（Block）_ 。区块链其实就是由一个长度不断增长的链表组成的，其中包含了很多记录，也就是区块。

![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/0547f5e8.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/625d51ca.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/6bb44bf6.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/b15e9b25.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/2fce85c9.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/ded225b1.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/89da738f.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/7e6e76af.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/7def190b.png)
...
![](https://simpleread.oss-cn-guangzhou.aliyuncs.com/sr_9riqre8wbz6tio9e/ee4eaf06.png)
